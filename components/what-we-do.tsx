      ...
      <div className="container mx-auto px-4 text-primary">
        ...
        >
          ...
          <p className="text-secondary max-w-5xl mx-auto">
            MRST CONSULTANCY L.L.C-FZ is dedicated to investment across multiple industries, creating value-driven
            opportunities by connecting businesses, investors, and students with the right resources and solutions.
          </p>
        </motion.div>
