...
import { ArrowRight, BarChart, Building, Globe, LineChart, Shield, Users } from "lucide-react"
      ...
      <section className="relative bg-primary">
        ...
        <div className="container mx-auto px-4 py-24 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeIn} className="max-w-3xl">
            ...
            <Button size="lg" className="group bg-secondary hover:bg-secondary/90 text-primary">
          ...
          >
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all bg-primary hover:shadow-lg">
                ...
                <CardContent>
                  <p className="">
                    Access to international investor networks, connecting your business with the right capital partners.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all bg-primary hover:shadow-lg">
                ...
                <CardContent>
                  <p className="">
                    Preparation of business plans and investment memoranda that effectively communicate your value
                    proposition.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all bg-primary hover:shadow-lg">
                ...
                <CardContent>
                  <p className="">
                    Expert assessment of business worth and growth potential, ensuring fair valuation for investment
                    discussions.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all bg-primary hover:shadow-lg">
                ...
                <CardContent>
                  <p className="">
                    Identification of investors who bring value beyond capital, including expertise, networks, and
                    market access.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all bg-primary hover:shadow-lg">
                ...
                <CardContent>
                  <p className="">
                    Ongoing guidance to maximize investment outcomes, supporting growth and strategic development.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Leveraging our strategic position in Dubai, we specialize in facilitating investments between key global
              markets.
            </p>
          </motion.div>
          ...
          >
            <p className="text-lg mb-8 max-w-3xl mx-auto">
              MRST Consultancy brings together investors and opportunities with precision and care, creating lasting
              value through thoughtful cross-border investment partnerships.
            </p>
            <Button size="lg" className="bg-secondary text-primary hover:bg-secondary/90">Discuss Your Investment Needs</Button>
          </motion.div>
        </div>
      </section>
