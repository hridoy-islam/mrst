        ...
        <div className="container mx-auto px-4 py-24 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="mb-8 opacity-90">
              ...
              operations. We guide businesses through the complexities of
              cross-border commerce, ensuring compliance while maximizing
              efficiency.
            </p>
            <Button
              size="lg"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className=" max-w-3xl mx-auto text-black">
              Comprehensive solutions to help your business expand into
              international markets with confidence and compliance.
            </p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Customized research and planning for new market penetration,
                    helping you identify opportunities and navigate challenges.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all border-primary border-2 hover:shadow-lg">
                <CardHeader className="pb-3">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Expert handling of certificates of origin, commercial
                    invoices, and shipping documents to ensure smooth customs
                    clearance.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all border-primary border-2 hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Navigation of international trade laws, standards, and
                    regulations to minimize risk and avoid costly penalties.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all border-primary border-2 hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Strategic planning for cost-effective transportation and
                    distribution, optimizing your supply chain for international
                    markets.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full transition-all border-primary border-2 hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Guidance on letters of credit, export financing, and risk
                    mitigation strategies to protect your business interests.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className=" max-w-3xl mx-auto text-black">
              Strategic import solutions that optimize your supply chain and
          ...
          >
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Sourcing reliable suppliers from global markets, with
                    thorough vetting and quality assurance processes.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Management of customs clearance, duties, and import
                    regulations to ensure smooth entry of goods into your target
                    market.
                  </p>
                </CardContent>
              </Card>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Implementation of inspection protocols and quality assurance
                    measures to ensure products meet your standards.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Optimization of procurement processes and inventory
            ...
            <motion.div variants={fadeIn}>
              <Card className="h-full border-primary border-2 transition-all hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Strategic assessment to reduce landed costs and improve
                    margins, identifying opportunities for savings.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-black">
              We offer specialized expertise across diverse sectors, tailoring
              our approach to meet the unique requirements of each industry.
            </p>
          </motion.div>
              ...
              <motion.div key={index} variants={fadeIn}>
                <div className="bg-primary rounded-lg p-6 h-full transition-all hover:shadow-md">
                  ...
                  <p className="text-gray-600">
                    ...
                    opportunities in this sector, ensuring compliance with
      ...
      <section className="py-20 bg-secondary text-primary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className=" mb-8">
              Let our experts guide you through the complexities of
              international trade and help your business thrive in global
              markets.
            </p>
            <Button
              size="lg"
              variant="outline"
              className="bg-secondary text-primary hover:bg-gray-100"
            >
              Contact Us Today
            </Button>
          </motion.div>
