  ...
  return (
    <div className="bg-background">
      ...
      <motion.section
        ...
        variants={fadeIn}
        custom={1}
        className="grid md:grid-cols-2 gap-12 py-12 items-center"
      >
        <div className="space-y-4">
          <h2 className="text-3xl text-primary font-semibold">Full-Cycle Development</h2>
          <p className="text-gray-600">
            Our expert team handles the entire process—acquiring land, planning,
            constructing, marketing, and selling. This ensures control,
            efficiency, and strong returns at every stage.
          </p>
        </div>
        <Image
          src="/state1.jpg"
