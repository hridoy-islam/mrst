      ...
      <div className="container py-16 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            strategy for London Churchill College for over a decade, he
            continues to explore creative outreach methods to engage potential
            learners. Holding an MBA in Management, Mr Chowdhury successfully
            operates multiple businesses across healthcare, real estate, and
            retail industries. His leadership focuses on empowering teams,
            establishing institutions, and implementing robust, cost-effective
            systems that drive efficiency and productivity in various business
            environments.
          </motion.p>
